...
/**
 * main - it displays the information contained in the ELF header
 * @ac: its the number of arguments passed into the program
 * @av: its the Array of arguments passed.
 * Return: 0 on success.
 */
